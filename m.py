...
bot = telebot.TeleBot('7214129057:AAHMNx72pl94qSlufFzqIunc06yLK6xBKPw')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴡ:- @Shailesh2347."
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @Shailesh2347 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Fʀᴇᴇ Kᴇ Dʜᴀʀᴍ Sʜᴀʟᴀ Hᴀɪ Yᴀ Jᴏ Mᴜ Uᴛᴛʜᴀ Kᴀɪ Kʜɪ Bʜɪ Gᴜꜱ Rʜᴀɪ Hᴏ Bᴜʏ Kʀᴏ Fʀᴇᴇ Mᴀɪ Kᴜᴄʜ Nʜɪ Mɪʟᴛᴀ Bᴜʏ:- @Shailesh2347 🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @Shailesh2347"
    bot.reply_to(message, response)
...
@bot.message_handler(commands=['shailesh'])
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "Yᴏᴜ Aʀᴇ Oɴ Cᴏᴏʟᴅᴏᴡɴ ❌. Pʟᴇᴀsᴇ Wᴀɪᴛ 10sᴇᴄ Bᴇғᴏʀᴇ Rᴜɴɴɪɴɢ Tʜᴇ  /shailesh Cᴏᴍᴍᴀɴᴅ Aɢᴀɪɴ."
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 180:
                ...
                record_command_logs(user_id, '/shailesh', target, port, time)
            ...
            response = "𝐃𝐄𝐀𝐑 𝐔𝐒𝐄𝐑. 🧨\n\n𝐔𝐒𝐀𝐆𝐄 /shailesh < 𝐈𝐏 > < 𝐏𝐎𝐑𝐓 > < 𝐓𝐈𝐌𝐄 >\n\n𝙁𝙊𝙍 𝙀𝙓𝘼𝙈𝙋𝙇𝙀 :-> /shailesh 20.0.0.0 10283 100\n\n𝘿𝙊𝙉'𝙏 𝙎𝙋𝘼𝙈 ⚠️‼️\nᴛʜɪs ʙᴏᴛ ᴏᴡɴᴇʀ ❤️‍🩹:--> @Shailesh2347"  # Updated command syntax
    else:
        response = ("🚫 ᴜɴᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴀᴄᴄᴇꜱꜱ! 🚫\n\nᴏᴏᴘꜱ! ɪᴛ ꜱᴇᴇᴍꜱ ʟɪᴋᴇ ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴘᴇʀᴍɪꜱꜱɪᴏɴ ᴛᴏ ᴜꜱᴇ ᴛʜᴇ /shailesh ᴄᴏᴍᴍᴀɴᴅ. ᴛᴏ ɢᴀɪɴ ᴀᴄᴄᴇꜱꜱ ᴀɴᴅ ᴜɴʟᴇᴀꜱʜ ᴛʜᴇ ᴘᴏᴡᴇʀ ᴏꜰ ᴀᴛᴛᴀᴄᴋꜱ, ʏᴏᴜ ᴄᴀɴ:\n\n👉 ᴄᴏɴᴛᴀᴄᴛ ᴀɴ ᴀᴅᴍɪɴ ᴏʀ ᴛʜᴇ ᴏᴡɴᴇʀ ꜰᴏʀ ᴀᴘᴘʀᴏᴠᴀʟ.\n🌟 ʙᴇᴄᴏᴍᴇ ᴀ ᴘʀᴏᴜᴅ ꜱᴜᴘᴘᴏʀᴛᴇʀ ᴀɴᴅ ᴘᴜʀᴄʜᴀꜱᴇ ᴀᴘᴘʀᴏᴠᴀʟ.\n💬 ᴄʜᴀᴛ ᴡɪᴛʜ ᴀɴ ᴀᴅᴍɪɴ ɴᴏᴡ ᴀɴᴅ ʟᴇᴠᴇʟ ᴜᴘ ʏᴏᴜʀ ᴄᴀᴘᴀʙɪʟɪᴛɪᴇꜱ\n\n🚀 ʀᴇᴀᴅʏ ᴛᴏ ꜱᴜᴘᴇʀᴄʜᴀʀɢᴇ ʏᴏᴜʀ ᴇxᴘᴇʀɪᴇɴᴄᴇ? ᴛᴀᴋᴇ ᴀᴄᴛɪᴏɴ ᴀɴᴅ ɢᴇᴛ ʀᴇᴀᴅʏ ꜰᴏʀ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴛᴛᴀᴄᴋꜱ!\n\n𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 @Shailesh2347")
...
💥 /shailesh : Mᴇᴛʜᴏᴅ Fᴏʀ Bɢᴍɪ Sᴇʀᴠᴇʀ. 
...
Buy From :-@Shailesh2347
Official Channel :- https://t.me/+e0UcnJ6gvKBlMTg1
'''
...
3. MAKE SURE YOU JOINED https://t.me/+e0UcnJ6gvKBlMTg1 OTHERWISE NOT WORK
